 ...
 * Hiển thị danh sách các file test trong thư mục và thư mục con
 */

// Tiêu đề trang
$title = "Buffet Booking MVC - Tests Directory";

// Thư mục gốc
$baseDir = __DIR__;
$baseUrl = '/buffet_booking_mvc/tests';
...
<body>
    ...
    <div class="breadcrumbs">
        <a href="<?php echo $baseUrl; ?>">Tests Home</a>
        <?php
        ...
        <?php foreach ($files as $file): ?>
            ...
            <div class="item file">
                <a href="<?php echo $fileUrl; ?>" class="<?php echo $fileExt; ?>-file">
                    <?php echo ($fileExt === 'php') ? '🧪' : '📄'; ?> <?php echo $file; ?>
                </a>
    ...
    <footer style="margin-top: 30px; border-top: 1px solid #ecf0f1; padding-top: 10px; color: #7f8c8d; font-size: 0.9em;">
        <p>Buffet Booking MVC - Test Directory Browser</p>
    </footer>
</body>
</html>
