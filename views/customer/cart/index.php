            ...
            <div class="col-lg-4">
                <div class="card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isLoggedIn()): ?>
                            <a href="<?= SITE_URL ?>/index.php?page=order&action=checkout" class="btn btn-primary w-100 btn-lg">
                                <i class="fas fa-credit-card"></i> Thanh toán
                            </a>
                        <?php else: ?>
                            <p class="text-muted small mb-2">Vui lòng đăng nhập để thanh toán</p>
                            <a href="<?= SITE_URL ?>/index.php?page=auth&action=login" class="btn btn-primary w-100">
