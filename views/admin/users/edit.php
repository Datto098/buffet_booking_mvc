...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateRolePermissions() {
            const selectedRole = roleSelect ? roleSelect.value : '<?= $user['role'] ?>';
            if (selectedRole && permissions[selectedRole]) {
                ...
                rolePermissions.innerHTML = '<p class="text-muted">No permissions available.</p>';
            }
        }
        ...
        // Update permissions when role changes (only if role select exists)
        if (roleSelect) {
