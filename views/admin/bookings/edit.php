...
<body>
    ...
    <?php require_once 'views/admin/layouts/footer.php'; ?>    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            initializeBookingEditForm('<?= $booking['id'] ?>');
        });

        // Override global functions with booking-specific IDs
        window.confirmDelete = () => confirmBookingDelete();
        window.sendConfirmation = () => sendBookingConfirmation('<?= $booking['id'] ?>');
    </script>
    ...
    <!-- Scripts -->    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html>
